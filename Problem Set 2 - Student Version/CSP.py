...
class UnaryConstraint(Constraint):
    ...
    # A function that takes the variable's value and returns whether it satisfies the constraint or not.
    condition: Callable[[Any], bool]

    def __init__(self, variable: str, condition: Callable[[Any], bool]) -> None:
        super().__init__()
        self.variable = variable
        self.condition = condition  # return true or false
...
class BinaryConstraint(Constraint):
    # The name of the two variables that are in the constraint.
    variables: Tuple[str, str]
    # A function that takes the variables' values and returns whether they satisfies the constraint or not.
...
class Problem:
    # A list of the variable names in the problem
    variables: List[str]
